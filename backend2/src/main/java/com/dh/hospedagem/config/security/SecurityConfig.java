...
////                    .antMatchers(HttpMethod.POST, "/auth1").permitAll()
...
//////            return null;
//            http.authorizeHttpRequests().antMatchers("/h2-console/**", "/**", "/products/**","/categorias","/caracteristicas", "/api/usuarios/**", "/auth1").permitAll()
//                .anyRequest().authenticated()
//                .and().csrf().disable()
//                .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
